use std::error::Error;
use crate::backup_item::{BackupItem, BackupType};
use crate::backup_schedule_db;
use std::time::{Duration, SystemTime, UNIX_EPOCH};
use tokio::time::{interval, Elapsed};
...
impl BackupSchedule {
	pub fn new(id: u32, server: u32, backup_type: BackupType, interval: u32, exec_if_empty: bool, exec_if_offline: bool) -> Self {
		Self {
			id,
			server,
			backup_type,
