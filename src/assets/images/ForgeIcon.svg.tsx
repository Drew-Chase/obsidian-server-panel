...
{
    return (
        <svg xmlns="http://www.w3.org/2000/svg" version="1.1" x="0px" y="0px" viewBox="0 0 100 100" enable-background="new 0 0 100 100" width={props.size || props.width || 100} height={props.size || props.height || 100}>
